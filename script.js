// ===== NIUBI WEEKLY — landing interactions =====
...
// --- Countdown to match day: Thu 25 Jun 2026, 17:00 (local) ---
const target = new Date('2026-06-25T17:00:00').getTime()
...
const revealTargets = document.querySelectorAll(
  '.sec-head, .pillar, .fcard, .bracket, .rules-note, .guide-flow, .guide-flow__step, .guide-card, .group, .teams-note, .venue__info, .venue__map, .stat, .register__inner'
)
